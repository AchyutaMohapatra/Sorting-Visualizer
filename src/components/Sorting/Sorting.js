...
class Sorting extends Component{
    ...
    sortFunc=(e)=>{
        ...
        if(this.state.method=="Algorithms"){
            ...
            else if(this.state.method=="Bubble Sort")
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="#" onClick={()=>this.setState({method:"Bubble Sort"})}>Bubble sort</a>
                                <a class="dropdown-item" href="#" onClick={()=>this.setState({method:"Heap Sort"})}>Heap sort</a>
