            ...
            <div className="back">
              ...
              <div class="box title">
                    <div className="container-fluid solid">
                        <ul className="links">
                            <li onClick={()=>window.open("https://github.com/AchyutaMohapatra","_blank")}>
                                <i>
                                    <Github/>
                                </i>
                            </li>
                            <li onClick={()=>window.open("https://www.linkedin.com/in/achyuta-kumar-mohapatra-54894a21a/","_blank")}>
                                <i>
                                    <LinkedIn/>
                                </i>
                            </li>
                ...
                <h1 className="main-title center">
                            ...
                            Sortation <strong style={{color:"var(--home-color)"}}><br></br>Visualization</strong>
                </h1>
                <div>
